...
\begin{defn}{Линейная оболочка}{}
    \begin{itemize}
        \item
            \( v_1, v_2, \ldots, v_k \in V \)

            \( \langle v_1, \ldots, v_k \rangle \) --- множество всех линейных комбинаций \( v_1, \ldots, v_k \)
        \item
            \( E \subseteq V \) --- любое

            \(
                \langle E \rangle = \{ \alpha_1 v_1 + \ldots + \alpha_k v_k
                \ \vline \
...
\begin{thrm}{}{}
    \( V \) --- векторное пространство над \( F \), \( E \subseteq V \)
...
Тогда \( U = \langle e_1, \ldots, e_n \rangle \).
Но с другой стороны \( E \) --- максимальное ЛНЗ в \( V \), поэтому \( E \) является и базисом \( V \).
Но тогда \( V = \langle e_1, \ldots, e_n \rangle = U \).
...
\begin{defn}{Столбцовый ранг}{}
    \begin{gather*}
        ...
        \end{pmatrix}
        \\
        \rk_\text{столб} A = \dim \langle A_1, \ldots, A_n \rangle
    \end{gather*}
\end{defn}
...
\begin{defn}{Строчной ранг}{}
    \begin{gather*}
        ...
        \end{pmatrix}
        \\
        \rk_\text{строч} A = \dim \langle A_1, \ldots, A_n \rangle
    \end{gather*}
\end{defn}
...
\begin{defn}{Тензорный ранг}{}
    ...
    \( \rk_T A = \min \{ k \ \vline \ A = x_1 y_1 + \ldots + x_k y_k, \: x_i \in F^m, y_i^T \in F^n \} \)
...
\begin{itemize}
    \item
        ...
        Поэтому
        \( \dim \langle A_1, \ldots, A_n \rangle = \dim \langle B_1, \ldots, B_n \rangle \)
    \item
        \( A \mapsto AD = B \)
        ...
        Поэтому \( \langle B_1, \ldots, B_n \rangle \subseteq \langle A_1, \ldots, A_n \rangle \).
...
\( \Rightarrow \langle A_1, \ldots, A_n \rangle \subseteq \langle B_1, \ldots, B_k \rangle \).

Но тогда \( \rk_\text{столб} \dim \langle A_1, \ldots, A_n \rangle \leq k = \rk_\text{Ф} \).

Выше показали, что неравенство верно и в другую сторону \( \Rightarrow \rk_\text{Ф} = \rk_\text{столб} \)
...
\( \hom_F (V, U) = \{ \varphi \ \vline \ \varphi : V \to U - \text{\( F \)-линейно} \} \)
...
\begin{defn}{Образ}{}
    \( \Img \Phi = \{ \Phi(v) \in U \ \vline \ v \in V \} = \Phi(V) \)
\end{defn}

\begin{remark}{}{}
    \( \ker \Phi \subseteq V \) --- подпространство

    \( \Img \Phi \subseteq U \) --- подпространство
\end{remark}
...
\begin{example}{}{}
    ...
    \(
        \Img \Phi = \{ Ax \in F^m \ \vline \ x_i \in F \} = \langle A_1, \ldots, A_n \rangle
    \)
...
\begin{lemma}{}{}
    ...
    \begin{enumerate}
        ...
        \item
            \( \Phi \) сюръективно \( \Leftrightarrow \) \( \Img \Phi = U \)
        \item
...
\( \Img A = \{ Ax \in F^m \ \vline \ x \in F^k \} \)

Поэтому \( \rk A = \dim \Img A \)

Хотим доказать:
\[
    \dim \Img A + \dim \Img B - k \leq \dim \Img AB
\]

Рассмотрим \( A \: \vline_{\: \Img B} \).
Оно переводит вектор из \( \Img B \) в \( F^m \),
причем:
\[
    \Img A \: \vline_{\: \Img B} = \Img AB
\]

Из суммы размерностей ядра и образа:
\[
    \dim \Img A \: \vline_{\: \Img B} + \dim \ker A \: \vline_{\: \Img B} = \dim \Img B
\]

Из соображений здравого смысла:
\begin{gather*}
    \ker A \: \vline_{\: \Img B} = \Img B \cap \ker A \subseteq \ker A
    \\
    \Downarrow
    \\
    \dim \ker A \: \vline_{\: \Img B} \leq \dim \ker A
\end{gather*}
...
\begin{gather*}
    \dim \Img A \: \vline_{\: \Img B} + \dim \ker A \: \vline_{\: \Img B} = \dim \Img B
    \\
    \dim \Img AB + \dim \ker A \: \vline_{\: \Img B} = \dim \Img B
    \\
    \dim \Img AB
        = \dim \Img B - \dim \ker A \: \vline_{\: \Img B}
        \leq \dim \Img B - \dim \ker A
        = \\
        = \dim \Img B - (k - \dim \Img A)
        = \dim \Img A + \dim \Img B - k
\end{gather*}
...
\begin{gather*}
    ...
    \\
    \sum \alpha_i e_i + \sum \beta_i f_i = - \sum \gamma_i g_i = z
\end{gather*}

\( z \in U, z \in W \Rightarrow z \in U \cap W \Rightarrow z = \sum \delta_i e_i \)
\begin{gather*}
...
\begin{example}{}{}
    ...
    то \( \langle e_1, e_2 \rangle \) и \( \langle e_3 \rangle \) --- ЛНЗ.
\end{example}
...
\begin{thrm}{}{}
    ...
    \begin{enumerate}
        ...
        \item
            \( U_i = \langle e_i \rangle \) (\( e_i \) --- базис \( U_i \)) \( \Rightarrow \)
...
\begin{itemize}
    ...
    \item
        ...
        Хотим показать, что \( ( U_1 ) \cap (U_2 + \ldots + U_k) = 0 \)
        \begin{gather*}
            \dim (( U_1 ) \cap (U_2 + \ldots + U_k))
            =
            \\
            =
            \dim U_1 + \dim (U_2 + \ldots + U_k) - \dim (U_1 + \ldots + U_k)
            \leq
            \\
            \leq
            \dim U_1 + \dim U_2 + \ldots + \dim U_k - \dim (U_1 + \ldots + U_k)
            =
            0
        \end{gather*}

        Поэтому \( \dim (( U_1 ) \cap (U_2 + \ldots + U_k)) = 0 \),
        то есть это нулевое пространство.
    \item
        \( (5) \Rightarrow (1) \)
